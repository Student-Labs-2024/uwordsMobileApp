...
class _$FinalScreenImpl implements _FinalScreen {
  ...
  @override
  String toString() {
    return 'TrainingState.finalScreen(valueKey: $valueKey, words: $words, newProgress: $newProgress)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return finalScreen(valueKey, words, newProgress);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return finalScreen?.call(valueKey, words, newProgress);
  }
...
abstract class _FinalScreen implements TrainingState {
  const factory _FinalScreen(
      {required final ValueKey<dynamic> valueKey,
      required final List<WordModel> words,
      required final List<int> newProgress}) = _$FinalScreenImpl;
